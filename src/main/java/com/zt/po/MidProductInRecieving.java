 ...
 * @author whl
 * @date 2019年6月22日
    *     半成品入库管理（关联到入库单 纯粹为外部购买的）
 */
@Entity
@Table(name="zt_midproductinrecieving")//
@org.hibernate.annotations.Table(appliesTo = "zt_midproductinrecieving",comment="半成品入库管理")
public class MidProductInRecieving extends BasePo{
