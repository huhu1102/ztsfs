 ...
 */
@Entity
@Table(name="zt_rowmaterialpurchaseverify")
@org.hibernate.annotations.Table(appliesTo = "zt_rowmaterialpurchaseverify",comment="原料采购确认详情")
public class RowMaterialPurchaseVerify extends BasePo{
	/**
	 * 
	 */
	...
	//关联采购计划详情
	@ManyToOne
	private RowMaterialPurchasePlanDetail purchasePlanDetail;
	...
	public RowMaterialPurchasePlanDetail getPurchasePlanDetail() {
		return purchasePlanDetail;
	}


	public void setPurchasePlanDetail(RowMaterialPurchasePlanDetail purchasePlanDetail) {
