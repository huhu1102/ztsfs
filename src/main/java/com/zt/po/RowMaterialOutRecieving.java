 ...
 */
@Entity
@Table(name="zt_rowmaterialoutrecieving")//
@org.hibernate.annotations.Table(appliesTo = "zt_rowmaterialoutrecieving",comment="原材料入库管理")
public class RowMaterialOutRecieving extends BasePo{
